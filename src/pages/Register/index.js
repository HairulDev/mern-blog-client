                ...
                <div className="card shadow p-2">
                  <div className="float-left">
                    <div className="float-right">
                      <h6 className="text-right m-2 ">Register <i className="fa fa-align-left"></i></h6>
                    </div>
                  </div>
                <form>
                  ...
                  <Gap height={20} />
                  <Button title="Register" className='btn btn-block btn-primary mb-2' />
                  <Button title="Back to Login" className='btn btn-block btn-outline-warning' />
                </form>
                </div>
              </div>
